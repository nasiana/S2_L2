...
print(
    f'Default value for number_tires: - {AnotherCar.number_tires} - and the number_tires for audi: - {audi.number_tires} -')
audi.number_tires = 6
print(
    f'Default value for number_tires: - {AnotherCar.number_tires} -, number_tires for audi: - {audi.number_tires} and number_tires for bmw: - {bmw.number_tires} -')
...
class Album:
    ...
    def __init__(self, name, artist,
                 songs) -> None:  # this -> None as is in here does absolutely nothing; it is an annotation
        self.name = name
        self.artist = artist
        self.songs = songs
